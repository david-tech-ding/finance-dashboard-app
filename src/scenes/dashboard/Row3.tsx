  ...
  return (
    <>
      ...
      <DashboardBox gridArea="j">
        ...
        <Typography variant="h4" margin="0 1rem">
          Hello, I'm David and my interest lies within FinTech, any
          opportunities to break into the industry will mean the world to me :D
        </Typography>
      </DashboardBox>
    </>
  );
